        ...
        #             return False
            ...
            if writeup == "latex" and improvement:
                ...
                try:
                    ...
                    generate_latex(
                        coder, destination_dir, f"{destination_dir}/{args.old_paper_title}_improved_v2.pdf"
                    )
...
if __name__ == "__main__":
    ...
    meta_review_result = load_json_from_file(osp.join(args.example_papers_dir, "ai_sci_deepreview_results.json"))[args.old_paper_title][0]
    print("meta_review_result.keys():", meta_review_result.keys())
    meta_review_result = meta_review_result['meta_review']

    results_dir = "results_exp2_v2"
