        ...
        #             return False
            ...
            if writeup == "latex" and improvement:
                ...
                try:
                    ...
                    generate_latex(
                        coder, destination_dir, f"{destination_dir}/{args.old_paper_title}_improved_v3_0727.pdf"
                    )
                    ...
                    compile_latex(cwd, pdf_file=f"{args.old_paper_title}_improved_v3_0727_v2.pdf", timeout=timeout)
